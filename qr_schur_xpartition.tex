...
c   = \min\!\left(\frac{P\,M}{N^2},\; P^{1/3}\right),\qquad
P_x = P_y = \sqrt{P_1},\qquad P_z = c.
\label{eq:grid}
\end{equation}
...
\texttt{scqr3\_full25d\_bench.cu} and accepts \texttt{--px --py --pz}
flags to instantiate any factorization $P = P_x P_y P_z$.
...
$[2,2,1]$, $c{=}1$ & \texttt{passes=2} (CQR2) & 175 & 158 & 930 & $1.1$--$6.6\times$ \\
