...
# include("lu_fullmixed_clean.jl") # <-- Ensure this filename matches your implementation file
...
function check_lu_time_hierarchical()
    ...
    println("="^60)
    println("Starting Clean getrf_recursive! Benchmark (2k - 16k)")
    println("="^60)
    ...
    # ==========================================================================
    plt = plot(
        title="Clean Hierarchical LU Performance vs. Matrix Size",
    ...
    savefig(plt, "getrf_recursive_clean_runtimes.png")
    println("\nPlot saved as getrf_recursive_clean_runtimes.png")
end
