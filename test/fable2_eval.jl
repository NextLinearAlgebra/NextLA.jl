...
# include("recsyrk.jl")
# include("wrappers.jl")
# include("fullmixedprec.jl") # <-- Ensure this points to the filename of your implementation above
...
function get_accuracy_mixed_lu(A_fp64::CuMatrix, precisions::Vector)
    ...
    # Reconstruct dense GPU matrix using your implementation's native reconstruct_matrix
