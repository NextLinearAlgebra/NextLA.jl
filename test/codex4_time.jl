...
# Include the file where you saved the getrf_recursive! implementation above
# include("lu_fullmixed_getrf.jl") # <-- Ensure this filename matches your implementation file
...
function check_lu_time_hierarchical()
    ...
    println("="^60)
    println("Starting getrf_recursive! Performance Benchmark (2k - 16k)")
    println("="^60)
    ...
    for n in n_values
        ...
        # 1. Benchmark Pure Float32 Baseline (using block_size = 4096 to match LU_BASECASE)
    ...
    # ==========================================================================
    plt = plot(
        title="getrf_recursive! Performance vs. Matrix Size",
    ...
    savefig(plt, "getrf_recursive_runtimes.png")
    println("\nPlot saved as getrf_recursive_runtimes.png")
end
