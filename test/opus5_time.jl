...
# Include the file where you saved this latest direct getrf_recursive! implementation
# include("lu_fullmixed_direct_recmixed.jl") # <-- Ensure this filename matches your implementation file
...
function run_time_mixed_lu(A_fp32::CuMatrix{Float32}, precisions::Vector{DataType})
    ...
    # Hits getrf_recursive!(A::FullMixedPrec), passing A.A11 directly to unified_rectrxm!
...
function check_lu_time_hierarchical()
    ...
    println("="^60)
    println("Starting Direct getrf_recursive! Benchmark (2k - 16k)")
    println("="^60)
    ...
    # ==========================================================================
    plt = plot(
        title="Direct Hierarchical LU Performance vs. Matrix Size",
    ...
    savefig(plt, "getrf_recursive_direct_recmixed_runtimes.png")
    println("\nPlot saved as getrf_recursive_direct_recmixed_runtimes.png")
end
