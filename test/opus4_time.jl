...
# include("lu_fullmixed_direct.jl") # <-- Ensure this filename matches your implementation file
...
function check_lu_time_hierarchical()
    ...
    savefig(plt, "getrf_recursive_direct_runtimes.png")
    println("\nPlot saved as getrf_recursive_direct_runtimes.png")
end
