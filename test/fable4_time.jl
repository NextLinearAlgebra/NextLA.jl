...
# include("lu_fullmixed_nopivot.jl") # <-- Ensure this filename matches your implementation file
...
function run_time_pure_lu(A_fp32::CuMatrix{Float32}, block_size::Int=4096)
    ...
    # Hits getrf_recursive!(A::AbstractMatrix, block_size), routing to getrf_nopivot! at leaf
...
function check_lu_time_hierarchical()
    ...
    println("="^60)
    println("Starting getrf_nopivot! Hierarchical Benchmark (2k - 16k)")
    println("="^60)
    ...
    savefig(plt, "getrf_recursive_nopivot_runtimes.png")
    println("\nPlot saved as getrf_recursive_nopivot_runtimes.png")
end
