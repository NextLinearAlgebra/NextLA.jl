...
@inline adjoint_blas_char(::Type{<:Complex}) = 'C'
@inline adjoint_blas_char(::Type) = 'T'

"""
    batch_views(A, r=size(A, 2)) -> Vector{<:AbstractMatrix}
...
"""
@inline batch_views(A::AbstractArray{T,3}, r::Int=size(A, 2)) where {T} =
